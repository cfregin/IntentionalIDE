...
functionDeclaration
  ...
  { methods.add("Got function functionDeclaration:" + $Identifier.text +", parameter:" + $formalParameterList.text + ", With function content:" + $functionBody.text);}
  ;
...
formalParameterList
  : '(' (LT!* t1=Identifier (LT!* ',' LT!* t2=Identifier)*)? LT!* ')'
  { methods.add("formalParameterList:" + $t1.text + ":and following:" + $t2);}
  ;
